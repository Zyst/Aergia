...
describe("Timer component", () => {
  ...
  describe("Display time", () => {
    ...
    it("Should return seconds as seconds with 00 minutes", () => {
      ...
      expect(displayTime(1)).toBe("00:01");
      expect(displayTime(11)).toBe("00:11");
    ...
    it("Should return minutes properly", () => {
      ...
      expect(displayTime(80)).toBe("01:20");
      expect(displayTime(120)).toBe("02:00");
      expect(displayTime(660)).toBe("11:00");
    });

    it("Should return hours properly (No Zero pad)", () => {
      expect(displayTime(3600)).toBe("1:00:00");
      expect(displayTime(3660)).toBe("1:01:00");
